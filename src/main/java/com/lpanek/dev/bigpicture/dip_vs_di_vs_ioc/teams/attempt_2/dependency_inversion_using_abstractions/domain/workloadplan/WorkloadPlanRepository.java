package com.lpanek.dev.bigpicture.dip_vs_di_vs_ioc.teams.attempt_2.dependency_inversion_using_abstractions.domain.workloadplan;
...
public class WorkloadPlanRepository {
	...
	private Map<WorkloadPlanId, WorkloadPlanAnemia> createRepositoryWithInitialData() {
		...
		WorkloadPlanAnemia workloadPlanAnemia = new WorkloadPlanAnemia(new WorkloadPlanId(FULL_TIME_WORKLOAD_PLAN_ID), dailyWorkloads);
