package com.lpanek.dev.bigpicture.dip_vs_di_vs_ioc.dip.attempt_2.dependency_inversion_using_abstractions.domain.resource.team;
...
import com.lpanek.dev.bigpicture.dip_vs_di_vs_ioc.dip.attempt_2.dependency_inversion_using_abstractions.domain.resource.ResourceId;
...
public class ResourceCapacityProviderImpl implements ResourceCapacityProvider {
	...
	@Override
	public Capacity getCapacityFor(DatePeriod period, com.lpanek.dev.bigpicture.dip_vs_di_vs_ioc.dip.attempt_2.dependency_inversion_using_abstractions.domain.team.ResourceId resourceId) {
	...
	private ResourceId toDomain(
			com.lpanek.dev.bigpicture.dip_vs_di_vs_ioc.dip.attempt_2.dependency_inversion_using_abstractions.domain.team.ResourceId resourceId) {
