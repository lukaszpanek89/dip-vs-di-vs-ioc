package com.lpanek.dev.softwareplant.dip.vs.di.vs.ioc.teams.attempt1.typical_implementation.resource;

import java.util.HashMap;
import java.util.Map;
import static com.lpanek.dev.softwareplant.dip.vs.di.vs.ioc.teams.attempt1.typical_implementation.Constants.FULL_TIME_WORKLOAD_PLAN_ID;
import static com.lpanek.dev.softwareplant.dip.vs.di.vs.ioc.teams.attempt1.typical_implementation.Constants.JOHN_ID;
import static com.lpanek.dev.softwareplant.dip.vs.di.vs.ioc.teams.attempt1.typical_implementation.Constants.KATHY_ID;
import static com.lpanek.dev.softwareplant.dip.vs.di.vs.ioc.teams.attempt1.typical_implementation.Constants.POLISH_HOLIDAY_PLAN_ID;
